<form action="/equipos/{{$equipments->id}}" method="POST">
    ...
    <div class="form-group {{$errors->has('stock_number') ? 'has-error': ''}} ">
        ...
        <input type="text" name="stock_number" class="form-control" value="{{old('stock_number',$equipments->stock_number)}}" placeholder="RX-0000-1" required autofocus>
    ...
    <div class="form-group {{$errors->has('name') ? 'has-error': ''}} ">
        ...
        <input type="text" name="name" class="form-control" value="{{old('name',$equipments->name)}}" placeholder="Rayos X" required autofocus>
        @if ($errors->has('name'))
            <span class="help-block">
    ...
    <div class="form-group {{$errors->has('brand') ? 'has-error': ''}} ">
        ...
        <input type="text" name="brand" class="form-control" value="{{old('brand',$equipments->brand)}}" placeholder="Osteosys" required autofocus>
        @if ($errors->has('brand'))
            <span class="help-block">
    ...
    <div class="form-group {{$errors->has('model') ? 'has-error': ''}} ">
        ...
        <input type="text" name="model" class="form-control" value="{{old('model',$equipments->model)}}" placeholder="SONOST-3000" required autofocus>
        @if ($errors->has('model'))
            <span class="help-block">
    ...
    <div class="form-group {{$errors->has('laboratory_id') ? 'has-error': ''}} ">
        ...
        {!! Form::select('laboratory_id',$lab,$equipments->laboratory_id,['class' => 'form-control']) !!}
