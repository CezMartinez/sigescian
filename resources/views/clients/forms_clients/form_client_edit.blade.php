<form action="/clientes/{{$clients->id}}" method="POST">
    ...
    <div class="form-group {{$errors->has('name') ? 'has-error': ''}} ">
        ...
        <input type="text" name="name" class="form-control" value=" {{old('name',$clients->name)}}" placeholder="Juan Perez" required autofocus>
        @if ($errors->has('name'))
    ...
    <div class="form-group {{$errors->has('nit') ? 'has-error': ''}} ">
        ...
        <input type="text" name="nit" class="form-control" value="{{old('nit',$clients->nit)}}" placeholder="0933-011185-102-6" required autofocus>
        @if ($errors->has('nit'))
            <span class="help-block">
    ...
    <div class="form-group {{$errors->has('address') ? 'has-error': ''}} ">
        ...
        <textarea name="address" class="form-control" placeholder="Avenida Siempre Viva 742" required autofocus>{{old('address',$clients->address)}}</textarea>
