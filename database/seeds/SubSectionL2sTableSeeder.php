...
class SubSectionL2sTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('sub_section_level2s')->insert([
            'section' => 'Generalidades',
            'route'=>'seccion_4_3_1',
            'sub_section_level1_id' =>'3'
        ]);
        DB::table('sub_section_level2s')->insert([
