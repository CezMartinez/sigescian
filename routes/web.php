...
Route::get('servicios/radio-agua-226/{id}/confirmar','ClientOptionsController@confirmarRadio');
Route::get('servicios/frotis-radiacion/{id}/confirmar','ClientOptionsController@confirmarFrotis');
Route::get('servicios/control-de-calidad/{id}/confirmar','ClientOptionsController@confirmarControl');
Route::get('servicios/dosimetria-personal-externa/{id}/confirmar','ClientOptionsController@confirmarDosimetria');
Route::get('servicios/radio-agua-226/{id}/aceptar','ClientOptionsController@aceptarRadio');
Route::get('servicios/frotis-radiacion/{id}/aceptar','ClientOptionsController@aceptarFrotis');
Route::get('servicios/control-de-calidad/{id}/aceptar','ClientOptionsController@aceptarControl');
Route::get('servicios/dosimetria-personal-externa/{id}/aceptar','ClientOptionsController@aceptarDosimetria');
Route::get('servicios/radio-agua-226/{id}/rechazar','ClientOptionsController@rechazarRadio');
Route::get('servicios/frotis-radiacion/{id}/rechazar','ClientOptionsController@rechazarFrotis');
